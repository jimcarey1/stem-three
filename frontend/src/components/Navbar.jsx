...
const Navbar = () => {
  return (
    <div className='flex justify-between w-full h-15 bg-blue-500 px-5 text-white justify-items-center items-center'>
        <div className='flex gap-x-1 justify-items-center items-center hover:text-gray-300 cursor-pointer'>
            <img className='h-12 rounded-full' src='/images/k12_logo.png' alt='logo' />
            <p className='text-2xl font-bold'>K12 Techno</p>
        </div>
